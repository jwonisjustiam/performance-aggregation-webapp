...
- 운영그룹/운영파트/품목1/품목2는 외장하드 `PP1 / NC / Y3 / \`, 웨어러블 `PP2 / 모바일2 / 갤럭시워치9 / 갤럭시링`입니다.
...
- 일정별 다운로드는 J6:AK6 그룹 제목, J7:AK7 열 제목, J8부터 데이터이며 전환율(AF열)·달성률(AI열)은 각 행의 상대참조 수식과 `0.00%` 서식으로 자동 출력됩니다.
