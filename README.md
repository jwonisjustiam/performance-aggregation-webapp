...
- 네이버 쇼핑라이브 통계 수집기 CSV 연결: 라이브중 시청수로 `View(만)`을 채우고 유니크 결제자수/시청수로 전환율 계산

## 네이버 쇼핑라이브 통계 연결

`naver-live-stats-collector` 폴더의 Chrome 확장 프로그램을 사용합니다. 네이버 로그인 정보나 쿠키를 앱에 전달하지 않고, 로그인된 쇼핑라이브 관리툴에서 선택 날짜의 종료 방송 통계를 CSV로 저장합니다.

- 외장하드 계정: `삼성공식파트너 쇼마젠시`
- 웨어러블 계정: `삼성파트너 쇼마젠시`
- View(만): `라이브중 시청수 / 10,000`
- 전환율(%): `유니크 결제자수 / 라이브중 시청수 * 100`
- 통계 미매칭 또는 시청수 0: 빈칸

사용 절차는 `naver-live-stats-collector/README.md`를 확인하세요.
- 결과 파일 저장 후 재오픈 검증
- 접기/펼치기 가능한 사용 안내 제공
